...
namespace Bricknode.Soap.Sdk.Services
{
    public interface IBfsAssetService
    {
        ...
        /// <param name="bfsApiClientName"></param>
        /// <returns></returns>
        IAsyncEnumerable<GetInstrumentsResponse> GetInstrumentsInPagesAsync(GetInstrumentsArgs filters, GetInstrumentsFields? fields = null, int pageSize = 2000, int pageStartIndex = 0, string? bfsApiClientName = null);
