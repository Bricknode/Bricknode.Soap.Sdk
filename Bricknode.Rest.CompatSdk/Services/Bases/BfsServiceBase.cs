...
namespace Bricknode.Soap.Sdk.Services.Bases
{
    ...
    public abstract class BfsServiceBase
    {
        ...
        /// <summary>
        /// Resolves a generated REST resource client (e.g. <c>AccountsClient</c>) configured for the
        /// given API client name.
        /// </summary>
        protected ValueTask<TClient> GetClientAsync<TClient>(string? bfsApiClientName = null) where TClient : class
        {
            return _bfsApiClientFactory.CreateClientAsync<TClient>(bfsApiClientName);
        }
