...
namespace Bricknode.Soap.Sdk.Services
{
    ...
    {
        public BfsTaskService(IBfsApiClientFactory bfsApiClientFactory, ILogger<BfsService>? logger)
        ...
        public async Task<GetTasksResponse> GetTasksAsync(GetTasksArgs filters, string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.TaskClient>(bfsApiClientName);
            var restResponse = await client.SearchAsync(BfsJsonMapper.Map<RestApi.GetTasksRequest>(request));
            var response = BfsJsonMapper.Map<GetTasksResponse>(restResponse)!;
        ...
        public async Task<CreateTasksResponse> CreateTasksAsync(CreateTask[] tasks, string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.TaskClient>(bfsApiClientName);
            var restResponse = await client.CreateAsync(BfsJsonMapper.Map<RestApi.CreateTasksRequest>(request));
            var response = BfsJsonMapper.Map<CreateTasksResponse>(restResponse)!;
            ...
            UpdateTaskFields fieldsToUpdate, string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.TaskClient>(bfsApiClientName);
            var restResponse = await client.UpdateAsync(BfsJsonMapper.Map<RestApi.UpdateTaskRequest>(request));
            var response = BfsJsonMapper.Map<UpdateTaskResponse>(restResponse)!;
