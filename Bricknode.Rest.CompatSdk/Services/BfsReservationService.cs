...
namespace Bricknode.Soap.Sdk.Services
{
    ...
    {
        public BfsReservationService(IBfsApiClientFactory bfsApiClientFactory, ILogger<BfsService>? logger)
            ...
            string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.ReservationClient>(bfsApiClientName);
            var restResponse = await client.SearchAsync(BfsJsonMapper.Map<RestApi.GetReservationRequest>(request));
            var response = BfsJsonMapper.Map<GetReservationResponse>(restResponse)!;
            ...
            string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.ReservationClient>(bfsApiClientName);
            var restResponse = await client.CreateAsync(BfsJsonMapper.Map<RestApi.CreateReservationRequest>(request));
            var response = BfsJsonMapper.Map<CreateReservationResponse>(restResponse)!;
        ...
        public async Task<string> DeleteReservationsAsync(Guid[] reservationIds, string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.ReservationClient>(bfsApiClientName);
            var restResponse = await client.DeleteAsync(BfsJsonMapper.Map<RestApi.DeleteReservationRequest>(request));
