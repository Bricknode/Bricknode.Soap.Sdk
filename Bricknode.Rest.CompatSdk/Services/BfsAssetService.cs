...
namespace Bricknode.Soap.Sdk.Services
{
    ...
    public class BfsAssetService : BfsServiceBase, IBfsAssetService
    {
            ...
            ManualExecutionInterfaceOld[] executionInterfaces, string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.InstrumentsClient>(bfsApiClientName);
            var restResponse = await client.CreateManualExecutionInterfaceAsync(BfsJsonMapper.Map<RestApi.CreateManualExecutionInterfaceRequest>(request));
            var response = BfsJsonMapper.Map<CreateManualExecutionInterfaceResponse>(restResponse)!;
        ...
        public async Task<GetTradingVenueResponse> GetTradingVenuesAsync(GetTradingVenueArgs filters, string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.TradingVenuesClient>(bfsApiClientName);
            var restResponse = await client.SearchAsync(BfsJsonMapper.Map<RestApi.GetTradingVenueRequest>(request));
            var response = BfsJsonMapper.Map<GetTradingVenueResponse>(restResponse)!;
        ...
        public async Task<CreateTradingVenuesResponse> CreateTradingVenuesAsync(CreateTradingVenue[] createTradingVenues, string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.TradingVenuesClient>(bfsApiClientName);
            var restResponse = await client.CreateAsync(BfsJsonMapper.Map<RestApi.CreateTradingVenuesRequest>(request));
            var response = BfsJsonMapper.Map<CreateTradingVenuesResponse>(restResponse)!;
        ...
        public async Task<GetCashResponse> GetCashAsync(GetCashArgs filters, string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.CashClient>(bfsApiClientName);
            var restResponse = await client.SearchAsync(BfsJsonMapper.Map<RestApi.GetCashRequest>(request));
            var response = BfsJsonMapper.Map<GetCashResponse>(restResponse)!;
        ...
        public async Task<GetInstrumentsResponse> GetInstrumentsAsync(GetInstrumentsArgs filters, string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.InstrumentsClient>(bfsApiClientName);
            var restResponse = await client.SearchAsync(BfsJsonMapper.Map<RestApi.GetInstrumentsRequest>(request));
            var response = BfsJsonMapper.Map<GetInstrumentsResponse>(restResponse)!;
        ...
        public async IAsyncEnumerable<GetInstrumentsResponse> GetInstrumentsInPagesAsync(GetInstrumentsArgs filters, GetInstrumentsFields? fields = null, int pageSize = 2000, int pageStartIndex = 0, string? bfsApiClientName = null)
        {
            ...
            request.Args = filters;
            request.Fields = fields ?? GetFields<GetInstrumentsFields>();
            ...
            do
            {
                ...
                var restResponse = await client.SearchAsync(BfsJsonMapper.Map<RestApi.GetInstrumentsRequest>(request));
                response = BfsJsonMapper.Map<GetInstrumentsResponse>(restResponse)!;
        ...
        public async Task<GetInstrumentsByNameResponse> GetInstrumentsByNameAsync(GetInstrumentsByNameArgs filters, string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.InstrumentsClient>(bfsApiClientName);
            var restResponse = await client.SearchByNameAsync(BfsJsonMapper.Map<RestApi.GetInstrumentsByNameRequest>(request));
            var response = BfsJsonMapper.Map<GetInstrumentsByNameResponse>(restResponse)!;
        ...
        public async Task<CreateInstrumentResponse> CreateInstrumentsAsync(Instrument[] instruments, string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.InstrumentsClient>(bfsApiClientName);
            var restResponse = await client.CreateAsync(BfsJsonMapper.Map<RestApi.CreateInstrumentRequest>(request));
            var response = BfsJsonMapper.Map<CreateInstrumentResponse>(restResponse)!;
            ...
            UpdateInstrumentFields fieldsToUpdate, string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.InstrumentsClient>(bfsApiClientName);
            var restResponse = await client.UpdateAsync(BfsJsonMapper.Map<RestApi.UpdateInstrumentsRequest>(request));
            var response = BfsJsonMapper.Map<UpdateInstrumentResponse>(restResponse)!;
            ...
            GetAssetAccountTypeLimitationArgs filters, string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.AssetAccountTypeLimitationsClient>(bfsApiClientName);
            var restResponse = await client.SearchAsync(BfsJsonMapper.Map<RestApi.GetAssetAccountTypeLimitationRequest>(request));
            var response = BfsJsonMapper.Map<GetAssetAccountTypeLimitationResponse>(restResponse)!;
            ...
            AssetAccountTypeLimitation[] assetAccountTypeLimitations, string? bfsApiClientName = null)
        {
            ...
            var client = await GetClientAsync<RestApi.AssetAccountTypeLimitationsClient>(bfsApiClientName);
            var restResponse = await client.CreateAsync(BfsJsonMapper.Map<RestApi.CreateAssetAccountTypeLimitationRequest>(request));
            var response = BfsJsonMapper.Map<CreateAssetAccountTypeLimitationResponse>(restResponse)!;
